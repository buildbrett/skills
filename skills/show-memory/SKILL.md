...
From the project directory whose memory you want to see. Running it in a project root shows that project's memory; running it in a subproject shows the subproject's memory. The key is the directory you are in.
